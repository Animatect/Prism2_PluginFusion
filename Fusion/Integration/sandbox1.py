...
#     process_name = "FusionRenderNode.exe"  # Replace with the name of the process you want to check
...
# if __name__ == "__main__":
#     process_name_to_monitor = "Fusion.exe"  # Replace with the name of the process you want to monitor
...
# 			ProgressWinUpdate(msgwin, msgitm, "ProgressGUI Example", progressTable[step], step, totalSteps, 0.1)
