...
class Prism_Fusion_Integration(object):
    def __init__(self, core, plugin):
        ...
        if platform.system() == "Windows":
            self.examplePath = (
                self.core.getWindowsDocumentsPath() + "\\Fusion\\2019"
            )
            ...
            self.examplePath = os.path.join("/home", userName, "Fusion", "2019")
            ...
            self.examplePath = (
                "/Users/%s/Library/Preferences/Autodesk/Fusion/2019" % userName
            )
    ...
    def getExecutable(self):
        execPath = ""
        if platform.system() == "Windows":
            defaultpath = os.path.join(self.getFusionPath(), "Fusion.exe")
