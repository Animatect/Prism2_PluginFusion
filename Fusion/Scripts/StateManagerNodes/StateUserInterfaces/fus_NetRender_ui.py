...
class Ui_wg_NetRender(object):
    def setupUi(self, wg_NetRender):
        if not wg_NetRender.objectName():
            wg_NetRender.setObjectName(u"wg_NetRender")
        wg_NetRender.resize(497, 937)
        self.verticalLayout = QVBoxLayout(wg_NetRender)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.f_name = QWidget(wg_NetRender)
        ...
        self.horizontalLayout_12 = QHBoxLayout(self.f_updateVersion)
        self.horizontalLayout_12.setSpacing(6)
        self.horizontalLayout_12.setObjectName(u"horizontalLayout_12")
        self.horizontalLayout_12.setContentsMargins(9, 0, 9, 0)
        self.label_9 = QLabel(self.f_updateVersion)
        ...
        self.chb_upVersion = QCheckBox(self.f_updateVersion)
        self.chb_upVersion.setObjectName(u"chb_upVersion")
        ...
        self.gb_submit = QGroupBox(wg_NetRender)
        self.gb_submit.setObjectName(u"gb_submit")
        self.gb_submit.setCheckable(False)
        ...
        self.gb_previous = QGroupBox(wg_NetRender)
        ...
        self.retranslateUi(wg_NetRender)

        QMetaObject.connectSlotsByName(wg_NetRender)
    # setupUi

    def retranslateUi(self, wg_NetRender):
        wg_NetRender.setWindowTitle(QCoreApplication.translate("wg_NetRender", u"Image Render", None))
        ...
        self.label_9.setText(QCoreApplication.translate("wg_NetRender", u"Execute Savers Next version:", None))
#if QT_CONFIG(tooltip)
        self.chb_upVersion.setToolTip(QCoreApplication.translate("wg_NetRender", u"When this checkbox is disabled the submission will overwrite the previous rendered version whenever possible.", None))
#endif // QT_CONFIG(tooltip)
        self.chb_upVersion.setText("")
        self.gb_submit.setTitle(QCoreApplication.translate("wg_NetRender", u"Submit Render Job", None))
        self.l_manager.setText(QCoreApplication.translate("wg_NetRender", u"Manager:", None))
        self.l_rjPrio.setText(QCoreApplication.translate("wg_NetRender", u"Priority:", None))
        self.label_15.setText(QCoreApplication.translate("wg_NetRender", u"Frames per Task:", None))
        self.l_rjTimeout.setText(QCoreApplication.translate("wg_NetRender", u"Task Timeout (min)", None))
        self.label_18.setText(QCoreApplication.translate("wg_NetRender", u"Submit suspended:", None))
        self.chb_rjSuspended.setText("")
        self.label_19.setText(QCoreApplication.translate("wg_NetRender", u"Submit dependent files:", None))
        self.chb_osDependencies.setText("")
        self.label_16.setText(QCoreApplication.translate("wg_NetRender", u"Upload output:", None))
        self.chb_osUpload.setText("")
        self.label_17.setText(QCoreApplication.translate("wg_NetRender", u"Use Project Assets", None))
        self.chb_osPAssets.setText("")
        self.gb_osSlaves.setTitle(QCoreApplication.translate("wg_NetRender", u"Assign to slaves:", None))
        self.b_osSlaves.setText(QCoreApplication.translate("wg_NetRender", u"...", None))
        self.l_dlConcurrentTasks.setText(QCoreApplication.translate("wg_NetRender", u"Concurrent Tasks:", None))
        self.l_dlGPUpt.setText(QCoreApplication.translate("wg_NetRender", u"GPUs Per Task:", None))
        self.l_dlGPUdevices.setText(QCoreApplication.translate("wg_NetRender", u"Select GPU Devices:", None))
        self.le_dlGPUdevices.setPlaceholderText(QCoreApplication.translate("wg_NetRender", u"Enter Valid GPU Device Id(s)", None))
        self.gb_previous.setTitle(QCoreApplication.translate("wg_NetRender", u"Previous render", None))
        self.l_pathLast.setText(QCoreApplication.translate("wg_NetRender", u"None", None))
        self.b_pathLast.setText(QCoreApplication.translate("wg_NetRender", u"...", None))
    # retranslateUi
