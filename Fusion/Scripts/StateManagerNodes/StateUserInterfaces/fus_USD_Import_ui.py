...
class Ui_wg_USD_Import(object):
    ...
    def retranslateUi(self, wg_USD_Import):
        ...
        self.l_class.setText(QCoreApplication.translate("wg_USD_Import", u"ImportFile", None))
        self.gb_import.setTitle(QCoreApplication.translate("wg_USD_Import", u"Import", None))
        self.groupBox.setTitle(QCoreApplication.translate("wg_USD_Import", u"Version", None))
        ...
        self.b_browse.setText(QCoreApplication.translate("wg_USD_Import", u"Browse", None))
        ...
        self.l_keepRefEdits.setText(QCoreApplication.translate("wg_USD_Import", u"Keep Reference Edits:", None))
        self.chb_keepRefEdits.setText("")
        self.l_keepRefEdits_2.setText(QCoreApplication.translate("wg_USD_Import", u"Maya Namespaces:", None))
        self.chb_autoNameSpaces.setText(QCoreApplication.translate("wg_USD_Import", u"Auto", None))
        self.b_nameSpaces.setText(QCoreApplication.translate("wg_USD_Import", u"Remove", None))
        self.l_abcPath.setText(QCoreApplication.translate("wg_USD_Import", u"Alembic - Update path only (if exists)", None))
        self.chb_abcPath.setText("")
        self.l_trackObjects.setText(QCoreApplication.translate("wg_USD_Import", u"Keep track of connected objects:", None))
        self.chb_trackObjects.setText("")
        self.gb_objects.setTitle(QCoreApplication.translate("wg_USD_Import", u"Objects", None))
        self.b_selectAll.setText(QCoreApplication.translate("wg_USD_Import", u"Select all", None))
    # retranslateUi
