...
class Ui_wg_FBX_Import(object):
    def setupUi(self, wg_FBX_Import):
        if not wg_FBX_Import.objectName():
            wg_FBX_Import.setObjectName(u"wg_FBX_Import")
        wg_FBX_Import.resize(340, 600)
        self.verticalLayout = QVBoxLayout(wg_FBX_Import)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.f_name = QWidget(wg_FBX_Import)
        ...
        self.gb_import = QGroupBox(wg_FBX_Import)
        ...
        self.b_createFbxScene = QPushButton(self.f_keepRefEdits)
        self.b_createFbxScene.setObjectName(u"b_createFbxScene")

        self.horizontalLayout_10.addWidget(self.b_createFbxScene)
        ...
        QMetaObject.connectSlotsByName(wg_FBX_Import)
    # setupUi

    def retranslateUi(self, wg_FBX_Import):
        wg_FBX_Import.setWindowTitle(QCoreApplication.translate("wg_FBX_Import", u"ImportFile", None))
        self.l_name.setText(QCoreApplication.translate("wg_FBX_Import", u"State name:", None))
        self.l_class.setText(QCoreApplication.translate("wg_FBX_Import", u"ImportFile", None))
        self.gb_import.setTitle(QCoreApplication.translate("wg_FBX_Import", u"Import", None))
        self.groupBox.setTitle(QCoreApplication.translate("wg_FBX_Import", u"Version", None))
        self.label_3.setText(QCoreApplication.translate("wg_FBX_Import", u"Current Version:", None))
        self.l_curVersion.setText(QCoreApplication.translate("wg_FBX_Import", u"-", None))
        self.label_6.setText(QCoreApplication.translate("wg_FBX_Import", u"Latest Version:", None))
        self.l_latestVersion.setText(QCoreApplication.translate("wg_FBX_Import", u"-", None))
        self.l_autoUpdate.setText(QCoreApplication.translate("wg_FBX_Import", u"Auto load latest version:", None))
        self.chb_autoUpdate.setText("")
        self.b_browse.setText(QCoreApplication.translate("wg_FBX_Import", u"Browse", None))
        ...
        self.b_createFbxScene.setText(QCoreApplication.translate("wg_FBX_Import", u"Create Scene", None))
    # retranslateUi
